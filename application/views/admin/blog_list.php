	...
	<?php include_once('side_navbar.php'); ?>
		...
		<section class="content">
			<div class="container-fluid">
				...
				<a class="btn btn-info float-left" href="<?php echo base_url('blog/index')?>">Add Blog</a> </div>
				<!-- Basic Examples -->
									...
									<table id="example1" class="table table-striped table-bordered" style="width:100%">
										...
										foreach($blog_list as $key=>$value){
										 ...
										 ?>
											...
											<td>
											<a href="<?php echo base_url('blog/edit_blog/'.$value->id)?>"><i class="material-icons">mode_edit_outline</i></a>
											</td>
												<td><?php echo $value->title?></td>
												<td><img src="<?php echo base_url('uploads/admin/blog/'.$value->image)?>" width="50px" height="50px"></td>
